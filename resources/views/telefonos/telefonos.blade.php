        ...
        <div class="card mb-4 shadow h-100 d-flex flex-column">
          <div class="card-header mb-4" style="background-color: rgb(204, 35, 35)">
            <h4 class="card-title"><strong>Cod Interno:</strong> {{$telefono->serial}}
              <a href="{{ route('historiales.index', ['tipo' => 'telefonos', 'id' => $telefono->id]) }}" class="btn btn-danger float-end shadow"
          ...
          <div class="card-body">
            ...
            <p class="card-text text-black"><strong>Sitio:</strong> {{$telefono->ubicacion}}</p>
