...
<script>
    ...
    window.location.replace('{{ route('celulares.historial.index', $celular->id) }}');
});
</script>
@endif
    ...
    <div class="row" style="margin-top: 35px;">
        ...
        @if(count($historialCelular) > 0)
            ...
            <div class="sticky-btn-container"
                onclick="window.location.href='{{ route('mantenimientos.index', ['tipo' => 'celulares', 'id' => $celular->id]) }}'">
