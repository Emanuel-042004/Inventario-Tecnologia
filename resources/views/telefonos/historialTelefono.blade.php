...
<script>
    ...
    window.location.replace('{{ route('telefonos.historial.index', $telefono->id) }}');
});
</script>
@endif
    ...
    <div class="row" style="margin-top: 40px;">
        ...
        @if(count($historialTelefono) > 0)
            ...
            <div class="sticky-btn-container"
                onclick="window.location.href='{{ route('mantenimientos.index', ['tipo' => 'telefonos', 'id' => $telefono->id]) }}'">
