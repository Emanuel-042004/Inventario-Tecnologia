        ...
        <div class="card mb-4 shadow h-100 d-flex flex-column">
          <div class="card-header mb-4" style="background-color: rgb(204, 35, 35)">
            <h4 class="card-title"><strong>Cod Interno:</strong> {{$celular->serial}}
              <a href="{{ route('historiales.index', ['tipo' => 'celulares', 'id' => $celular->id]) }}" class="btn btn-danger float-end shadow"
          ...
          <div class="card-body">
            <p class="card-text text-black"><strong>Serial:</strong> {{$celular->s_n}}</p>
